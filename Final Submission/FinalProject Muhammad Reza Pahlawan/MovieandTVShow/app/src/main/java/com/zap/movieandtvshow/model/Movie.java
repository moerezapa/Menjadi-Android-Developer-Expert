...
public class Movie implements Parcelable {
    ...
    public Movie() {}
    public Movie(String poster_path, boolean adult, String overview, String release_date, List<Integer> genreIds, Integer id, String original_title, String originalLanguage, String title, String backdrop_path, Double popularity, Integer vote_count, Boolean video, Double vote_average) {
